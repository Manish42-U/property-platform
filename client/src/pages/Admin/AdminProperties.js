...
//         <h3>Error</h3>
//         <p>{error}</p>
//         <button onClick={fetchProperties} style={{ marginTop: '1rem', padding: '8px 16px', cursor: 'pointer' }}>
//           Retry
//         </button>
//       </div>
//     );
...
//   return (
//     <div>
//       <h1 style={{ marginBottom: '1.5rem' }}>Manage Properties</h1>
...
//                   ) : (
//                     <div style={{ width: '50px', height: '50px', background: '#ddd', borderRadius: '5px' }}></div>
//                   )}
//                 </td>
//                 <td>{property.title}</td>
//                 <td>{property.type === 'sale' ? 'Sale' : 'Rent'}</td>
